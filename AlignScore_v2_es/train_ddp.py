...
if __name__ == "__main__":
    ALL_TRAINING_DATASETS = {
        ### XNLI Dataset en español
        'xnli_es': {'task_type': 'nli', 'data_path': 'xnli_es_train.jsonl'},
        ### NLI
    ...
    parser.add_argument('--model-name', type=str, default="dccuchile/bert-base-spanish-wwm-cased")#modelo en español
